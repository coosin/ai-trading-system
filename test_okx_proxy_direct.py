...
async def test_okx_with_proxy():
    """测试OKX交易所（使用代理）"""
    
    print("=" * 60)
    print("测试OKX交易所连接（直接使用代理）")
    print("=" * 60)
    ...
    try:
        ...
        exchange._session = aiohttp.ClientSession(connector=connector)
...
if __name__ == "__main__":
    asyncio.run(test_okx_with_proxy())
