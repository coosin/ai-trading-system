...
from .decision_engine.multi_model import TradingSignal, Decision
...
class DataFusionEngine:
    ...
    async def fuse_data(self, symbol: str, market_data: Dict) -> Optional[FusedData]:
        ...
        try:
            ...
            fused_signal = await self._generate_fused_signal(
                symbol, technical_signals, onchain_metrics, 
                social_sentiment, market_structure
            )
            ...
            fused_data = FusedData(
                ...
                signal_strength=self._calculate_signal_strength(fused_signal) if fused_signal else 0.0,
                signal_consistency=self._calculate_signal_consistency(fused_signal, symbol) if fused_signal else 0.0
            )
    ...
    def _calculate_data_quality(self, *data_sources) -> float:
        ...
        for data in data_sources:
            if data:
                ...
                quality_score = 0.4 * existence_score + 0.4 * completeness_score + 0.2 * freshness_score
    ...
    def _record_performance(self, fused_data: FusedData):
        ...
        performance_record = {
            ...
            'signal_confidence': fused_data.fused_signal.confidence if fused_data.fused_signal else None
        }
    ...
    def generate_fusion_report(self, fused_data: FusedData) -> Dict:
        ...
        report = {
            ...
            "fused_signal": {
                "decision": fused_data.fused_signal.decision.value if fused_data.fused_signal else None,
                "confidence": fused_data.fused_signal.confidence if fused_data.fused_signal else None,
