...
class ConfigManager:
    ...
    async def set_config(self, section: str, key: str, value: Any, 
    ...
    async def watch_config(self, section: str, key: str, 
    ...
    async def unwatch_config(self, section: str, key: str, 
                            callback: Callable) -> None:
        """
        取消监听配置变更
    ...
    async def _load_all_configs(self) -> None:
        ...
        try:
            ...
            logger.warning("yaml模块未安装，跳过YAML配置文件")
    ...
    async def _notify_watchers(self, section: str, key: str, 
