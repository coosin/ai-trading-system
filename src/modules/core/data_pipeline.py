...
class DataPipeline:
    ...
    async def fetch_batch(self, symbol: str, start_time: datetime, 
                         end_time: datetime, source: str = None) -> DataBatch:
        """
        获取批量数据
    ...
    async def _fetch_from_source(self, source_name: str, symbol: str,
